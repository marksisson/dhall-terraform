          ...
          ( List
              ...
              , application_stack :
                  List
                    ...
                    , docker_container_registry : Text
                    , docker_container_tag : Text
                    , dotnet_version : Text
                    , java_container : Text
                  ...
                  List
                    { action :
                        List
                          { action_type : Text
                          , custom_action :
                              List { executable : Text, parameters : Text }
                          , minimum_process_execution_time : Text
                          }
                    , trigger :
                        List
                          { private_memory_kb : Natural
              ...
              , virtual_application :
                  List
                    ...
                    , preload : Bool
                    , virtual_directory :
                        List { physical_path : Text, virtual_path : Text }
                    , virtual_path : Text
                    }
