{ Type =
    ...
    , microsoft_app_msi_id : Optional Text
    , microsoft_app_tenant_id : Optional Text
    , microsoft_app_type : Optional Text
    , name : Text
...
, default =
  ...
  , luis_key = None Text
  , microsoft_app_msi_id = None Text
  , microsoft_app_tenant_id = None Text
  , microsoft_app_type = None Text
