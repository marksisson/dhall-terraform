    ...
    , site_config :
        List
          ...
          , application_stack :
              Optional
                ( List
                    { current_stack : Optional Text
                    , docker_container_name : Optional Text
                    , docker_container_registry : Optional Text
                    , docker_container_tag : Optional Text
          ...
          , auto_heal_setting :
              Optional
                ( List
                    ...
                    , trigger :
                        List
                          { private_memory_kb : Optional Natural
                          , requests :
                              Optional
              ...
              Optional
                ( List
                    ...
                    , virtual_directory :
                        Optional
                          ( List
                              { physical_path : Optional Text
                              , virtual_path : Optional Text
                              }
                          )
                    }
                )
