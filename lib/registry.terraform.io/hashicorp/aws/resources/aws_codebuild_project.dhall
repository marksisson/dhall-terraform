{ Type =
    ...
    , id : Optional Text
    , name : Text
    , project_visibility : Optional Text
    , public_project_alias : Optional Text
    , queued_timeout : Optional Natural
    , resource_access_role : Optional Text
    , service_role : Text
    ...
    , artifacts :
        List
          ...
          , bucket_owner_access : Optional Text
    ...
    , secondary_source_version :
        Optional (List { source_identifier : Text, source_version : Text })
    , secondary_sources :
        Optional
          ( List
...
, default =
  ...
  , id = None Text
  , project_visibility = None Text
  , public_project_alias = None Text
  , queued_timeout = None Natural
  , resource_access_role = None Text
  ...
  , secondary_source_version =
      None (List { source_identifier : Text, source_version : Text })
  , secondary_sources =
      None
        ( List
            { buildspec : Optional Text
