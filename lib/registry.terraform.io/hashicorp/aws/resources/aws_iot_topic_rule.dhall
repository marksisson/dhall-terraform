{ Type =
    ...
    , cloudwatch_logs :
        Optional (List { log_group_name : Text, role_arn : Text })
    , cloudwatch_metric :
        Optional
          ( List
              { metric_name : Text
        ...
        Optional
          ( List
              ...
              , http :
                  Optional
                    ( List
                        { confirmation_url : Optional Text
                        , url : Text
                        , http_header :
              ...
              , timestream :
                  Optional
                    ( List
                        ...
                        , role_arn : Text
                        , table_name : Text
                        , dimension : List { name : Text, value : Text }
                        , timestamp :
                            Optional (List { unit : Text, value : Text })
                        }
                    )
              }
          )
    ...
    , http :
        Optional
          ( List
              { confirmation_url : Optional Text
              , url : Text
              , http_header : Optional (List { key : Text, value : Text })
              }
          )
    ...
    , kafka :
        Optional
          ( List
              { client_properties : List { mapKey : Text, mapValue : Text }
              , destination_arn : Text
              , key : Optional Text
              , partition : Optional Text
              , topic : Text
    ...
    , timestream :
        Optional
          ( List
              ...
              , table_name : Text
              , dimension : List { name : Text, value : Text }
              , timestamp : Optional (List { unit : Text, value : Text })
              }
          )
    }
, default =
  ...
  , cloudwatch_logs = None (List { log_group_name : Text, role_arn : Text })
  , cloudwatch_metric =
      None
        ( List
            { metric_name : Text
