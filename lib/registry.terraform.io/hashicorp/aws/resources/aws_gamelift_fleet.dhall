{ Type =
    { arn : Optional Text
    , build_arn : Optional Text
    , build_id : Optional Text
    ...
    , script_arn : Optional Text
    , script_id : Optional Text
    , tags : Optional (List { mapKey : Text, mapValue : Text })
    , tags_all : Optional (List { mapKey : Text, mapValue : Text })
    , certificate_configuration :
        Optional (List { certificate_type : Optional Text })
...
, default =
  ...
  , script_arn = None Text
  , script_id = None Text
  , tags = None (List { mapKey : Text, mapValue : Text })
  , tags_all = None (List { mapKey : Text, mapValue : Text })
  , certificate_configuration = None (List { certificate_type : Optional Text })
  , ec2_inbound_permission =
      None
        ( List
            { from_port : Natural
