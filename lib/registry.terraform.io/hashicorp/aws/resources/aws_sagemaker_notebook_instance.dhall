{ Type =
    ...
    , platform_identifier : Optional Text
    , role_arn : Text
    ...
    , instance_metadata_service_configuration :
        Optional
          (List { minimum_instance_metadata_service_version : Optional Text })
    }
, default =
  { accelerator_types = None (List Text)
  ...
  , instance_metadata_service_configuration =
      None (List { minimum_instance_metadata_service_version : Optional Text })
  }
}
