{ Type =
    ...
    , db_cluster_instance_class : Optional Text
    , db_cluster_parameter_group_name : Optional Text
    , db_instance_parameter_group_name : Optional Text
    ...
    , serverlessv2_scaling_configuration :
        Optional (List { max_capacity : Natural, min_capacity : Natural })
    , timeouts :
        Optional
...
, default =
  ...
  , db_cluster_instance_class = None Text
  , db_cluster_parameter_group_name = None Text
  , db_instance_parameter_group_name = None Text
  , db_subnet_group_name = None Text
  , deletion_protection = None Bool
  , enable_global_write_forwarding = None Bool
  ...
  , serverlessv2_scaling_configuration =
      None (List { max_capacity : Natural, min_capacity : Natural })
  , timeouts =
      None
        { create : Optional Text
        , delete : Optional Text
