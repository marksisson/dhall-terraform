{ Type =
    ...
    , time_period_start : Optional Text
    , time_unit : Text
    , cost_filter : Optional (List { name : Text, values : List Text })
    , cost_types :
        Optional
          ( List
...
, default =
  ...
  , time_period_start = None Text
  , cost_filter = None (List { name : Text, values : List Text })
  , cost_types =
      None
        ( List
            { include_credit : Optional Bool
