{ Type =
    ...
    , default_user_settings :
        List
          ...
          , jupyter_server_app_settings :
              Optional
                ( List
                    { lifecycle_config_arns : Optional (List Text)
                    , default_resource_spec :
                        Optional
                          ( List
                              { instance_type : Optional Text
                              , lifecycle_config_arn : Optional Text
                              , sagemaker_image_arn : Optional Text
                              , sagemaker_image_version_arn : Optional Text
                              }
                          )
                    }
                )
    ...
    , retention_policy :
        Optional (List { home_efs_file_system : Optional Text })
    }
, default =
  ...
  , url = None Text
  , retention_policy = None (List { home_efs_file_system : Optional Text })
  }
}
