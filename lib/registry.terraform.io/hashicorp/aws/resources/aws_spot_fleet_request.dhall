{ Type =
    ...
    , on_demand_max_total_price : Optional Text
    ...
    , terminate_instances_on_delete : Optional Text
...
, default =
  ...
  , on_demand_max_total_price = None Text
  ...
  , terminate_instances_on_delete = None Text
