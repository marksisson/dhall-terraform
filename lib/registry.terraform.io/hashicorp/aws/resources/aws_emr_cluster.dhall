{ Type =
    ...
    , list_steps_states : Optional (List Text)
    , log_encryption_kms_key_id : Optional Text
    ...
    , auto_termination_policy :
        Optional (List { idle_timeout : Optional Natural })
    , bootstrap_action :
        Optional
...
, default =
  ...
  , list_steps_states = None (List Text)
  , log_encryption_kms_key_id = None Text
  , log_uri = None Text
  ...
  , auto_termination_policy = None (List { idle_timeout : Optional Natural })
  , bootstrap_action =
