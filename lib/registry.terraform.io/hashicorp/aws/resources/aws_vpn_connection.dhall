{ Type =
    { arn : Optional Text
    , core_network_arn : Optional Text
    , core_network_attachment_arn : Optional Text
    ...
    , outside_ip_address_type : Optional Text
    ...
    , transport_transit_gateway_attachment_id : Optional Text
...
, default =
  { arn = None Text
  , core_network_arn = None Text
  , core_network_attachment_arn = None Text
  ...
  , outside_ip_address_type = None Text
  ...
  , transport_transit_gateway_attachment_id = None Text
