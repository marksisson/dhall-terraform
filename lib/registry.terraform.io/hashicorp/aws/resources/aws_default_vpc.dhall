{ Type =
    ...
    , existing_default_vpc : Optional Bool
    , force_destroy : Optional Bool
    , id : Optional Text
    , instance_tenancy : Optional Text
    , ipv6_association_id : Optional Text
    , ipv6_cidr_block : Optional Text
    , ipv6_cidr_block_network_border_group : Optional Text
    , ipv6_ipam_pool_id : Optional Text
...
, default =
  ...
  , existing_default_vpc = None Bool
  , force_destroy = None Bool
  , id = None Text
  , instance_tenancy = None Text
  , ipv6_association_id = None Text
  , ipv6_cidr_block = None Text
  , ipv6_cidr_block_network_border_group = None Text
  , ipv6_ipam_pool_id = None Text
