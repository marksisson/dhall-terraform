{ Type =
    ...
    , name : Optional Text
    , nchar_character_set_name : Optional Text
    ...
    , restore_to_point_in_time :
        Optional
          ( List
              ...
              , source_db_instance_automated_backups_arn : Optional Text
...
, default =
  ...
  , customer_owned_ip_enabled = None Bool
  , db_name = None Text
  ...
  , multi_az = None Bool
  , name = None Text
  , nchar_character_set_name = None Text
