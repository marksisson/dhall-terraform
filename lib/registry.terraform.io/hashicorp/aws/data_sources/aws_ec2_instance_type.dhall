{ Type =
    ...
    , encryption_in_transit_supported : Optional Bool
    , fpgas :
        Optional
          ( List
              { count : Natural
    ...
    , inference_accelerators :
        Optional (List { count : Natural, manufacturer : Text, name : Text })
    , instance_disks :
        Optional (List { count : Natural, size : Natural, type : Text })
...
, default =
  ...
  , encryption_in_transit_supported = None Bool
  , fpgas =
      None
        ( List
            { count : Natural
  ...
  , id = None Text
  , inference_accelerators =
      None (List { count : Natural, manufacturer : Text, name : Text })
  , instance_disks =
      None (List { count : Natural, size : Natural, type : Text })
