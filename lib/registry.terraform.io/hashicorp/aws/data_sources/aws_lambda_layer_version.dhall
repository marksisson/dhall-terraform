{ Type =
    { arn : Optional Text
    , compatible_architecture : Optional Text
    , compatible_architectures : Optional (List Text)
...
, default =
  { arn = None Text
  , compatible_architecture = None Text
  , compatible_architectures = None (List Text)
